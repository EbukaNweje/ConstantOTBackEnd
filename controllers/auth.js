      ...
      <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
        <tr>
          <td style="text-align: center;">
            <!-- <h1 style="margin: 0;"><a href="#" style="color: #EABD4E; font-size: 24px; font-weight: 700; font-family: 'Lato', sans-serif;">ConstantOT</a></h1> -->
          </td>
        </tr>
      </table>
    </td>
        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">Welcome to ConstantOT Official Cryptocurrency Platform, your Number 1 online trading platform.</h3>
              <p>
            ...
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
              <tr>
                <td style="text-align: left; padding-left: 10px;">
                  ...
                  <ul>
                    <li style="color: #fff;"><a href="https://constantot.netlify.app" style="color: #30e3ca;">Home</a></li>
                    <li style="color: #fff;"><a href="https://constantot.netlify.app/about" style="color: #30e3ca;">About</a></li>
                    <li style="color: #fff;"><a href="https://constantot.netlify.app/faq" style="color: #30e3ca;">FAQ</a></li>
                    <li style="color: #fff;"><a href="https://constantot.netlify.app/sendrequest" style="color: #30e3ca;">Ask a question</a></li>
                  </ul>
                </td>
              </tr>
            </table>
...
exports.loginEmailSand = async (req, res, next) =>{
        ...
        <tr>
          <td>
            <div style="padding: 0 1.5em; text-align: center;">
              ...
              <h3 style="font-family: 'Lato', sans-serif; font-size: 24px; font-weight: 300;">You have successfully logged in to,<br/> <span style=" font-weight: 500; color:#EABD4E; margin-top:-10px; font-size: 20px;">ConstantOT Official Cryptocurrency Platform</span></h3>
  ...
  exports.getrestlink = async (req, res, next)=>{
    ...
    try{
      res
      .redirect(`https://constantot.netlify.app/restLink/${id}/${token}`)
    }catch(err){next(err)}
  }
